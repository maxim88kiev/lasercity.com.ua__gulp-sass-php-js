...
ContentLoader::addScript('dtime.min', true);
...
<header class="page-header">
  <div class="page-header__top-navigation">
    <div class="page-header__tuning">
      <a class="page-header__logo" <?php if ($current_page != 'home'): ?>href="<?= $current_sef . $current_city_alias->alias ?>" aria-label="<?=JText::_('COM_LASERCITY_A_HEADER')?> LaserCity"<?php endif; ?>>
      ...
      <div class="page-header__settings">
        <div class="page-header__setting-city">
          <button class="page-header__setting-city-button" type="button" title="<?=JText::_('COM_LASERCITY_BUTTON_1_HEADER')?>" aria-label="<?=JText::_('COM_LASERCITY_BUTTON_1_HEADER')?>">
        ...
        <button class="page-header__search-button" type="button" title="<?=JText::_('COM_LASERCITY_BUTTON_2_HEADER')?>" aria-label="<?=JText::_('COM_LASERCITY_BUTTON_2_HEADER')?>"><span class="visually-hidden"><?=JText::_('COM_LASERCITY_BUTTON_2_HEADER')?></span></button>
...
<!--          <button class="page-header__setting-languages-button" type="button" title="--><?//=JText::_('COM_LASERCITY_BUTTON_3_HEADER')?><!--" aria-label="--><?//=JText::_('COM_LASERCITY_BUTTON_3_HEADER')?><!--">-->
<!--            <span class="visually-hidden">--><?//=JText::_('COM_LASERCITY_BUTTON_3_HEADER')?><!--</span>-->
<!--            <svg width="13" height="6" aria-hidden="true">-->
...
<!--                  <a href="--><?//=($lang->sef !== LangHelper::getCurrentSef()) ? str_replace(array("//"), "/","/$lang->sef/".$language_sef) : 'javascript:void(0);' ?><!--">--><?//= $lang->sef ?><!--</a>-->
<!--                </li>-->
<!--              --><?php //endforeach; ?>
<!--          </ul>-->
<!--        </div>-->
    ...
    <ul class="page-header__user-list user-list">
      <li class="user-list__item">
        <button class="user-list__link user-list__link--basket user-list__link--none" type="button" title="<?=JText::_('COM_LASERCITY_BUTTON_4_HEADER')?>" aria-label="<?=JText::_('COM_LASERCITY_BUTTON_4_HEADER')?>">
          <svg class="basket" width="30" height="30" fill="#999999" viewBox="0 0 321.2 321.2" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
            <g>
          ...
          <span class="items">
            ...
            <svg class="heart" fill="#dc025e" width="19" height="17" viewBox="0 0 176.104 176.104" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
              <g>
      ...
      <li class="user-list__item">
        <button class="user-list__link user-list__link--login" data-set-modal-value="singup" type="button" title="<?=JText::_('COM_LASERCITY_BUTTON_6_HEADER')?>" aria-label="<?=JText::_('COM_LASERCITY_BUTTON_6_HEADER')?>">
          <svg width="30" height="30" fill="#999999" viewBox="0 0 482.9 482.9" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
            <g>
        ...
        <ul class="main-navigation__list">
          <li class="main-navigation__item">
            <a <?php if ($current_page != 'clinics'): ?>href="<?= $current_sef ?>clinics/<?= $current_city_alias->alias ?>"<?php endif; ?>
              ...
              <svg width="30" height="30" fill="#999999" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" aria-hidden="true">
          ...
          <li class="main-navigation__item main-navigation__item--sale">
            <a class="main-navigation__link main-navigation__link--sale" href="<?= $current_sef ?>stocks/"><?=JText::_('COM_LASERCITY_A_2_HEADER')?></a>
          </li>
          <li class="main-navigation__item">
            <a class="main-navigation__link main-navigation__link--articles"
              ...
              <span class="pc"><?=JText::_('COM_LASERCITY_A_3_HEADER')?></span><span class="mob"><?=JText::_('COM_LASERCITY_A_4_HEADER')?></span>
            </a>
          </li>
          <li class="main-navigation__item">
            <a class="main-navigation__link main-navigation__link--faq"
               <?php if ($current_page != 'faq'): ?>href="<?= $current_sef ?>faq/"<?php endif; ?>>
              <svg width="30" height="30" fill="#999999" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 60 60" aria-hidden="true">
              ...
              <span class="pc"><?=JText::_('COM_LASERCITY_A_5_HEADER')?></span><span class="mob">FAQ</span>
            </a>
          </li>
        </ul>
      </div>
      <form class="main-navigation__search-from">
        <input class="main-navigation__search" type="search" aria-label="<?=JText::_('COM_LASERCITY_INPUT_1_HEADER')?>" placeholder="<?=JText::_('COM_LASERCITY_INPUT_1_HEADER')?>">
        ...
        <button class="main-navigation__search-button-closed button-cross" type="button" title="<?=JText::_('COM_LASERCITY_BUTTON_8_HEADER')?>" aria-label="<?=JText::_('COM_LASERCITY_BUTTON_8_HEADER')?>"><span class="visually-hidden"><?=JText::_('COM_LASERCITY_BUTTON_8_HEADER')?></span></button>
      </form>
    </div>
  </nav>
</header>
...
<footer class="page-footer">
  <div class="page-footer__wrapper">
    <ul class="page-footer__navigation-list">
      ...
      <li class="page-footer__navigation-item"><a href="<?= $current_sef ?>privacy/"><?=JText::_('COM_LASERCITY_A_5_FOOTER')?></a></li>
      <li class="page-footer__navigation-item"><a href="#"><?=JText::_('COM_LASERCITY_A_6_FOOTER')?></a></li>
    </ul>
    <ul class="page-footer__aside-list">
      <li class="page-footer__aside-item"><a href="<?= $current_sef ?>articles/"><?=JText::_('COM_LASERCITY_A_7_FOOTER')?></a></li>
      <li class="page-footer__aside-item page-footer__aside-item--sale"><a href="<?= $current_sef ?>stocks/"><?=JText::_('COM_LASERCITY_A_8_FOOTER')?></a></li>
      <li class="page-footer__aside-item"><a href="<?= $current_sef ?>clinics/"><?=JText::_('COM_LASERCITY_A_9_FOOTER')?></a></li>
      <li class="page-footer__aside-item"><a href="<?= $current_sef ?>faq/"><?=JText::_('COM_LASERCITY_A_10_FOOTER')?></a></li>
    </ul>
    <div class="page-footer__support-wrapper">
      <div class="page-footer__support">
        <div class="page-footer__support-header">
          ...
          <button class="page-footer__support-button button-corner" type="button" title="<?=JText::_('COM_LASERCITY_BUTTON_1_FOOTER')?>" aria-label="<?=JText::_('COM_LASERCITY_BUTTON_1_FOOTER')?>"><span class="visually-hidden"><?=JText::_('COM_LASERCITY_BUTTON_1_FOOTER')?></span>
          </button>
        </div>
        <div class="page-footer__contacts">
          <p class="page-footer__contacts-number"><?=JText::_('COM_LASERCITY_P_1_FOOTER')?>: <a href="tel:0992235388">(099) 223-53-88</a></p>
          <p class="page-footer__workdays">Пн-Пт, 09:00 - 18:00</p>
          <p class="page-footer__email">E-mail: <a href="mailto:laserciti@gmail.com">laserciti@gmail.com</a></p>
        </div>
      </div>
      <ul class="page-footer__social-list">
        <li class="page-footer__social-item">
          <a class="page-footer__social-item-link page-footer__social-item-link--facebook" href="#">
            <svg fill="#dc025e" width="46" height="46" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" aria-hidden="true">
        ...
        <li class="page-footer__social-item">
          <a class="page-footer__social-item-link page-footer__social-item-link--instagramm" href="#">
            <svg fill="#dc025e" width="46" height="46" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 409.602 409.602" aria-hidden="true">
        ...
        <li class="page-footer__social-item">
          <a class="page-footer__social-item-link page-footer__social-item-link--telegram" href="#">
            <svg fill="#dc025e" width="46" height="46" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 46 46">
